...
public class MyAdjacencyMatrixUndirectedGraph {
     ...
     * 创建图(自己输入数据)
     */
    public MyAdjacencyMatrixUndirectedGraph() {
     ...
     *     matrix-- 矩阵(数据)
     */
    public MyAdjacencyMatrixUndirectedGraph(char[] vexs, int[][] matrix) {
    ...
    public static void main(String[] args) {
        ...
        MyAdjacencyMatrixUndirectedGraph pG;

        // 自定义"图"(输入矩阵队列)
        //pG = new MatrixUDG();
        // 采用已有的"图"
        pG = new MyAdjacencyMatrixUndirectedGraph(vexs, matrix);
